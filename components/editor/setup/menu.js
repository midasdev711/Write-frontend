...
function linkItem(markType) {
  return new MenuItem({
    ...
    run(state, dispatch, view) {
      ...
      openPrompt({
        helperText: 'Type Enter to input link, or Esc to cancel',
        fixedPosition: true,
        fields: {
          href: new TextField({
...
export function buildMenuItems(schema) {
  ...
  // added floating menu configuration
  r.inlineFloating = [cut([r.toggleStrong, r.toggleEm, r.toggleLink])]
  r.floatingMenu = r.inlineFloating.concat([[r.makeHead1, r.makeParagraph, r.wrapBlockQuote]])
