...
let selectionSizePlugin = (option) => new Plugin({
  view(editorView) { return new SelectionSizeTooltip(editorView, option) }
})
...
class SelectionSizeTooltip {
  constructor(view, option) {
    ...
    // const separator = crel("span", { class: 'pm-separator' })
    // menu.insertBefore(separator, menu.childNodes[3]);
